...
//-------------------------------------
                ...
                $("nouveauClient").click("afficher_form_inscription")
...
//-------------------------------------
    ...
    <body>
        <header>
            ...
            <h1>Arsenal - Gunner</h1>

            <!--  Menu haut-->
            <nav id="menu_haut">
                <ul>
                    <li><a href="index.php"> Accueil </a></li>
                    <li><a href="index.php?controleur=produits&action=afficher"> Voir les Produits  </a></li>                

                    <li><a href="index.php?controleur=connexionclient&action=afficher"> Connexion </a></li>
                </ul>
            </nav>
        </header>